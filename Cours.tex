...
\section{Théorie des graphes:}
	...
	\subsection{Isomorphisme}
		...
		Pour prouver que 2 graphes sont isomorphe, on montre la bijection de chaque sommet (il doit avoir le même degré dans le graphe isomorphe et être adjacent aux mêmes sommets).\\ % uniquement ces conditions ? --> OUI
	...
	\subsection{Graphe Hamiltonien}
		...
		Un graphe $\Gamma = (V,E)$ est \textbf{biparti} si on peut écrire $V = B \cup W$ avec $B \cap W = \emptyset$ et toute arête de $\Gamma$ joint un sommet de $B$ à un sommet de $W$. Avec $B$ et $W$ des sous-ensembles de sommets. % Vérifier se qu'est B et W --> ?
		\begin{center}
			\begin{tikzpicture}
	...
	% Problème du voyageur du commerce volontairement ignoré, car peu pertinent. --> OK :p
	...
	\subsection{Ordre partiel}
		...
		On note $(P,\leq)$ un ensemble partiellement ordonné.\\ % Explication supplémentaire ? --> Nope, c'est une définition, pas d'explication. :)
